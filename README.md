...
```
평점 4.0 이상 기록  →  취향 중심 (임베딩 평균)
                        ↓
            내용 점수 0.3   줄거리가 취향 중심과 가까운 것
            이웃 점수 0.7   나와 겹치는 사람들이 좋아한 것 (자카드 ÷ 인기)
                        ↓
                    후보 30개
                        ↓
            한 시리즈에서 한 편까지만
...
이웃 점수를 인기로 나눈다. 안 나누면 점수 순서가 인기 순서와 83.5% 일치한다 — 모두가
...
200명에게 10개씩 낸 2,000자리에 서로 다른 작품이 366편 나온다. 상위 10편이 그중 21.6%.

**5편부터 인기순을 앞선다.** 2편은 인기순보다 못하고 3편은 동점이라 화면과 API 가
5편으로 막는다.
